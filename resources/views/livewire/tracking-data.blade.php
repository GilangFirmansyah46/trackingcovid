<div>
    <div class="form-group row ">
        ...
        <input type="text" value="@if(isset($tracking)){{$tracking->jumlah_positif}}@endif" class="form-control" name="jumlah_positif" required>
        </div>
    </div> 
        ...
        <div class="form-group row ">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="@if(isset($tracking)){{$tracking->jumlah_sembuh}}@endif"  name="jumlah_sembuh" value="{{$tracking->jumlah_sembuh}}" required>
            </div>
        </div>
        <div class="form-group row ">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="@if(isset($tracking)){{$tracking->jumlah_meninggal}}@endif" name="jumlah_meninggal" required>
            </div>
        </div>
        <div class="form-group row ">
            <div class="col-md-6">
